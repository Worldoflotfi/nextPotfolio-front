...
const AboutSection = () => {
    return (
        <section className="about bg-teal-500 text-gray-900 py-16" id="about">
                ...
                <div className="about-content md:w-2/3">
                    ...
                    <div className="flex flex-col sm:flex-row gap-4 justify-center">
                        <a
                            ...
                            className="px-6 py-3 bg-gray-900 text-teal-400 text-lg font-medium rounded-lg hover:bg-gray-700 transition duration-300"
                        >
